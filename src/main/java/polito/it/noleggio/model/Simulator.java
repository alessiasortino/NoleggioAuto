...
public class Simulator {
	...
	//Inizializzo con valori di default sensato
	private int NC= 10; //number of cars totali
	...
	// MODELLO DEL MONDO
	private int nAuto;// auto disponibili (tra 0 e NC)
	...
	private void processEvent(Event e) {
		...
		case NEW_CLIENT:
			// l'auto c'è--> cliente soddisfatto
			if(this.nAuto>0) {
